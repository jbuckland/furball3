...
const models_js_1 = require("../app/core/models.js");
...
class Data {
            ...
            for (var p = 0; p < buildList['pilots'].length; p++) {
                ...
                for (var upgradeType in rawAllUpgrades) {
                    ...
                    for (var u = 0; u < rawUpgradesOfType.length; u++) {
                        ...
                        var upgrade = new models_js_1.Upgrade();
    ...
    convertUpgradeNameToSlotType(rawUpgradeType) {
        var type = null;
        var map = {
            'ept': models_js_1.SlotType.ElitePilot,
            'mod': models_js_1.SlotType.Modification,
            'title': models_js_1.SlotType.Title,
            'bomb': models_js_1.SlotType.Bomb,
            'system': models_js_1.SlotType.System,
            'tech': models_js_1.SlotType.Tech,
            'missile': models_js_1.SlotType.Missile,
            'amd': models_js_1.SlotType.Astromech,
            'torpedo': models_js_1.SlotType.Torpedo,
            'turret': models_js_1.SlotType.Turret,
            'crew': models_js_1.SlotType.Crew,
            'samd': models_js_1.SlotType.SalvagedAstromech,
            'illicit': models_js_1.SlotType.Illicit
        };
